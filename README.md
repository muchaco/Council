...
Council includes local structured diagnostics logging for development and bug triage.

- Open **Settings -> Diagnostics** to open the logs folder, copy a summary, or export a diagnostics bundle.
- Logs are written locally to `<userData>/logs/diagnostics.ndjson`.
